...
fastq files and ends with counts matrix. Downstream differential
analysis support is coming soon!</sup>
...
:mailbox:](mailto:ccbr_pipeliner@mail.nih.gov) directly to get the
...
- [parkit](https://github.com/CCBR/parkit)
